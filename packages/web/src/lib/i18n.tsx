...
const translations = {
  en: {
    ...
    "form.notesPlaceholder": "Notes / details (optional)",
    ...
    "login.forgotDesc": "Enter your email and we'll send you a reset link.",
    "login.forgotSending": "Sending...",
    "login.forgotSend": "Send reset link",
    "login.forgotSentTitle": "Email sent",
    "login.forgotSentDesc": "If an account exists for that email, a reset link has been sent. Check your inbox.",
    "login.backToLogin": "Back to login",
    "reset.title": "Set new password",
    "reset.desc": "Enter your new password below.",
    "reset.newPassword": "New Password",
    "reset.newPasswordPlace": "Min 6 characters",
    "reset.confirm": "Confirm Password",
    "reset.confirmPlace": "Confirm your new password",
    ...
    "profile.fontSizeSmall": "Small",
    "profile.fontSizeNormal": "Normal",
    "profile.fontSizeLarge": "Large",
    "profile.fontSizeXlarge": "X-Large",
    ...
    "profile.weeklyRecap": "Weekly Recap",
    "profile.weeklyRecapDesc": "Get a Monday 9am email summarizing last week's tasks, hours and top category.",
    "profile.weeklyRecapEnable": "Send me a weekly recap email",
    ...
    "projects.issueDescriptionPlaceholder": "Description (optional, markdown supported)",
  ...
  tr: {
    ...
    "form.notesPlaceholder": "Açıklama / notlar (opsiyonel)",
    ...
    "login.forgotTitle": "Şifre sıfırlama",
    "login.forgotDesc": "E-posta adresini gir, sıfırlama linki gönderelim.",
    "login.forgotSending": "Gönderiliyor...",
    "login.forgotSend": "Sıfırlama linki gönder",
    "login.forgotSentTitle": "E-posta gönderildi",
    "login.forgotSentDesc": "Bu e-postaya kayıtlı bir hesap varsa sıfırlama linki gönderildi. Gelen kutunu kontrol et.",
    "login.backToLogin": "Girişe dön",
    "reset.title": "Yeni şifre belirle",
    "reset.desc": "Aşağıya yeni şifreni gir.",
    "reset.newPassword": "Yeni Şifre",
    "reset.newPasswordPlace": "En az 6 karakter",
    "reset.confirm": "Şifre Tekrar",
    "reset.confirmPlace": "Yeni şifreni tekrar gir",
    "reset.submit": "Şifremi Sıfırla",
    "reset.submitting": "Sıfırlanıyor...",
    "reset.success": "Şifren güncellendi! Artık giriş yapabilirsin.",
    "reset.invalidToken": "Bu link geçersiz veya süresi dolmuş.",
    ...
    "profile.fontSizeSmall": "Küçük",
    "profile.fontSizeNormal": "Normal",
    "profile.fontSizeLarge": "Büyük",
    "profile.fontSizeXlarge": "Çok Büyük",
    "profile.pomodoro": "Pomodoro",
    ...
    "profile.deleteAccountConfirm": "Hesabı sil",
    "common.cancel": "İptal",
    ...
    "profile.weeklyRecap": "Haftalık Özet",
    "profile.weeklyRecapDesc": "Pazartesi 09:00'da önceki haftanın görev, saat ve en çok kullanılan kategori özeti.",
    "profile.weeklyRecapEnable": "Haftalık özet e-postası al",
    ...
    "projects.issueDescriptionPlaceholder": "Açıklama (opsiyonel, markdown desteklenir)",
