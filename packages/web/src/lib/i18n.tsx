...
const translations = {
  en: {
    ...
    "stats.completedCount": "{count} completed",
    ...
    "insight.subtitle": "Patterns derived from your activity log",
    "insight.notReady": "Not enough data yet",
    "insight.notReadyDesc": "Insights appear once there is enough activity to say something honest. {days} days tracked so far.",
    "insight.lowConfidence": "limited data",
    "insight.peakHours": "You finish most work between {from} and {to} — {pct}% of everything you complete lands in that window.",
    "insight.categoryDriftUp": "{category} is up {pct}% over the last {weeks} weeks.",
    "insight.categoryDriftDown": "{category} dropped {pct}% over the last {weeks} weeks.",
    "insight.estimateBiasOver": "Tasks you estimate at {bucket} take {pct}% longer than planned ({items} tasks).",
    "insight.estimateBiasUnder": "Tasks you estimate at {bucket} finish {pct}% faster than planned ({items} tasks).",
    "insight.postponeRiskRelative": "Tasks you estimate at {bucket} get postponed {multiplier}x more often than the rest.",
    "insight.postponeRiskAbsolute": "Tasks you estimate at {bucket} get postponed {avgPostpones} times on average — your other tasks almost never are.",
    "insight.bestDow": "{dow} is your strongest day — {pct}% of your completions happen then.",
    "stats.hourHeatmap": "When You Finish Work",
    "stats.byDayOfWeek": "By Day of Week",
    "stats.categoryDrift": "Category Trend (weekly minutes)",
    "stats.noHourData": "No completion events recorded yet",
    "bucket.lt30": "under 30m",
    "bucket.30to60": "30–60m",
    "bucket.60to120": "1–2h",
    "bucket.gt120": "over 2h",
  ...
  tr: {
    ...
    "stats.completedCount": "{count} tamamlanan",
    ...
    // Insights (GMD-4)
    "insight.title": "İçgörüler",
    "insight.subtitle": "Aktivite geçmişinden çıkarılan örüntüler",
    "insight.notReady": "Henüz yeterli veri yok",
    "insight.notReadyDesc": "İçgörüler, dürüst bir şey söyleyecek kadar veri biriktiğinde görünür. Şu ana kadar {days} gün kayıt var.",
    "insight.lowConfidence": "sınırlı veri",
    "insight.peakHours": "İşlerini en çok {from}–{to} arasında bitiriyorsun — tamamladıklarının %{pct} kadarı bu aralıkta.",
    "insight.categoryDriftUp": "{category} son {weeks} haftada %{pct} arttı.",
    "insight.categoryDriftDown": "{category} son {weeks} haftada %{pct} düştü.",
    "insight.estimateBiasOver": "{bucket} olarak tahmin ettiğin işler planladığından %{pct} uzun sürüyor ({items} görev).",
    "insight.estimateBiasUnder": "{bucket} olarak tahmin ettiğin işler planladığından %{pct} erken bitiyor ({items} görev).",
    "insight.postponeRiskRelative": "{bucket} olarak tahmin ettiğin görevler, diğerlerine göre {multiplier} kat daha sık erteleniyor.",
    "insight.postponeRiskAbsolute": "{bucket} olarak tahmin ettiğin görevler ortalama {avgPostpones} kez erteleniyor — diğer görevlerin neredeyse hiç ertelenmiyor.",
    "insight.bestDow": "En güçlü günün {dow} — tamamladıklarının %{pct} kadarı o gün gerçekleşiyor.",
    "stats.hourHeatmap": "İşleri Ne Zaman Bitiriyorsun",
    "stats.byDayOfWeek": "Haftanın Günlerine Göre",
    "stats.categoryDrift": "Kategori Trendi (haftalık dakika)",
    "stats.noHourData": "Henüz tamamlama kaydı yok",
    "bucket.lt30": "30 dk altı",
    "bucket.30to60": "30–60 dk",
    "bucket.60to120": "1–2 saat",
    "bucket.gt120": "2 saat üstü",
